...
import LottieScrollAnimation from "./components/lottie-scroll-animation/LottieScrollAnimation";
import LottieSettings from "./@types/lottie-settings.interface";
...
export { LottieScrollSection, LottieAnimation, LottieScrollAnimation, LottieSettings, LottieScrollSectionProps, LottieScrollAnimationProps, LottieAnimationProps, Timeline };
